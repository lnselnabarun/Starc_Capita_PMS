...
export default function CombinedMutualFund() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
                        ...
                        <>
                          ...
                          >
                            ...
                            <td
                              ...
                              style={ { minWidth: "120px" } }
                            >
                              <div className="text-sm text-gray-900">{ items?.summery?.weightedStdDev }</div>
                            </td>
                            <td
                              className="px-6 py-1 whitespace-nowrap"
                              style={ { minWidth: "120px" } }
                            >
                              <div className="text-sm text-gray-900">{ items?.summery?.weightedSharpeRatio }</div>
                            </td>
                            <td
                              className="px-6 py-1 whitespace-nowrap"
                              style={ { minWidth: "120px" } }
      ...
      { isFilterOpen === true ? (
        <div
          className={ `fixed inset-y-0 left-0 w-full sm:w-80 bg-gray-100 shadow-lg transform ${isFilterOpen ? "translate-x-0" : "-translate-x-full"
