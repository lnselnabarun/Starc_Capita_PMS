                  ...
                  <tr>
                    ...
                    {headers.slice(2).map((header, index) => (
                      <th
                        ...
                        style={{ minWidth: header.includes("Current VALUE") ? "150px" : "120px" }}
                      >
                        {header}
                      </th>
                    ))}
                  ...
                  {filteredData?.map((item) => (
                    <tr key={item.id} className="hover:bg-gray-50">
                      ...
                      <td 
                        ...
                        style={{ minWidth: "200px", maxWidth: "250px", boxShadow: "2px 0 5px -2px rgba(0,0,0,0.1)" }}
                      >
                      ...
                      <td 
                        ...
                        style={{ minWidth: "150px", boxShadow: "2px 0 5px -2px rgba(0,0,0,0.1)" }}
                      >
                      ...
                      <td className="px-6 py-4 whitespace-nowrap" style={{ minWidth: "120px" }}>
                        <div className="text-sm text-gray-900">
                          {item?.currentXIRR ? `${item.currentXIRR}%` : '0%'}
                        </div>
                      </td>
                      {/* Current Value */}
                      <td className="px-6 py-4 whitespace-nowrap" style={{ minWidth: "150px" }}>
                        <div className="text-sm text-gray-900">
                          {`₹${formatMoney(item?.currentValue?.toFixed(2) || 0)}`}
                        </div>
                      </td>
                      {/* Expense Ratio */}
                      <td className="px-6 py-4 whitespace-nowrap" style={{ minWidth: "120px" }}>
                        <div className="text-sm text-gray-900">
                          {item?.["ARF-InterimNetExpenseRatio"] ? `${item["ARF-InterimNetExpenseRatio"]}%` : '0%'}
                        </div>
                      </td>
                      {/* Exit Load */}
                      <td className="px-6 py-4 whitespace-nowrap" style={{ minWidth: "120px" }}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap" style={{ minWidth: "120px" }}>
                        <div className="text-sm text-gray-900">
                        {item?.["Rolling Return Max 0.08333333333333333YR"]}
                       
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap" style={{ minWidth: "120px" }}>
                        <div className="text-sm text-gray-900">
                        {item?.["Rolling Return Avg 0.08333333333333333YR"]}
                       
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap" style={{ minWidth: "120px" }}>
                        <div className="text-sm text-gray-900">
                        {item?.["Rolling Return Min 0.08333333333333333YR"]}
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap" style={{ minWidth: "120px" }}>
                        <div className="text-sm text-gray-900">
                      ...
                      {/* Additional data columns would go here */}
                      {/* For brevity, we're not including all columns */}
                      
                      {/* Action column */}
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium" style={{ minWidth: "100px" }}>
                        <button
                          onClick={() =>
          ...
          <div className="p-6">
            ...
            <div className="mb-6">
              <div className="flex justify-between items-center mb-2">
                ...
                <button onClick={() => toggleSection("category")} className="focus:outline-none">
            ...
            <div className="mb-6">
              <div className="flex justify-between items-center mb-2">
                ...
                <button onClick={() => toggleSection("cost")} className="focus:outline-none">
