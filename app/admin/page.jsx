...
const Admin = () => {
  ...
  useEffect(() => {
    // Set a timeout to change state after 2.5 seconds (2500ms)
  ...
  return (
    <>
      {state === null ? (
        ...
        <div className="flex justify-center items-center h-screen w-screen overflow-hidden bg-white">
        <div className="relative w-full h-full animate-fadeIn"> {/* Applying the fade-in animation */}
          <Image
        //    src={require("../app/assets/logo/Thumbnail.png")} // Replace with your image path
           src={require("../../app/assets/logo/Thumbnail.png")} // Replace with your image path
        ...
        <div className="bg-primary w-full overflow-hidden bg-slate-50 min-h-screen ">
          ...
          <div className="flex flex-col justify-center items-center px-4 md:px-20 mt-10">
            <main className="text-center">
              ...
              <h6 className="font-light font-poppins text-base sm:text-lg text-neutral-500 mx-4 sm:mx-20">
                The investment management platform is a standalone web
                application designed to provide users with comprehensive tools
                to manage and analyze their investments. It will integrate with
                financial data providers to fetch real-time data for stocks and
                mutual funds.
              </h6>
            </main>
          </div>
          ...
          <div className="flex flex-col md:flex-row mx-4 md:mx-20 mt-5">
            <div className="w-full md:w-1/2 flex flex-col space-y-4 p-4">
              ...
              <div className="flex items-center border border-gray-150 group hover:border-fuchsia-950 p-5 h-24 rounded-lg">
                <div className="w-16 h-16 rounded-full bg-gray-200 flex items-center justify-center overflow-hidden mr-4">
                  <Image
                    src={require("../../app/assets/logo/Vector.png")}
                    alt="Example"
                    width={40}
                    height={40}
                  />
              ...
              <div className="flex items-center border border-gray-150 group hover:border-fuchsia-950 p-5 h-24 rounded-lg">
                <div className="w-16 h-16 rounded-full bg-gray-200 flex items-center justify-center overflow-hidden mr-4">
                  <Image
                    src={require("../../app/assets/logo/Import_export.png")}
                    alt="Example"
                    width={40}
                    height={40}
                  />
              ...
              <div className="flex items-center border border-gray-150 group hover:border-fuchsia-950 p-5 h-24 rounded-lg">
                <div className="w-16 h-16 rounded-full bg-gray-200 flex items-center justify-center overflow-hidden mr-4">
                  <Image
                    src={require("../../app/assets/logo/Addchart.png")}
                    alt="Example"
                    width={40}
                    height={40}
                  />
                ...
                <span className="font-poppins font-semibold text-left text-black group-hover:text-fuchsia-950 text-sm">
                  Gain portfolio insights with analytical and performance
                  reports
                </span>
              </div>
              {/* Fourth item */}
              <div className="flex items-center border border-gray-150 group hover:border-fuchsia-950 p-5 h-24 rounded-lg">
                <div className="w-16 h-16 rounded-full bg-gray-200 flex items-center justify-center overflow-hidden mr-4">
                  <Image
                    src={require("../../app/assets/logo/Trending_up.png")}
                    alt="Example"
                    width={40}
                    height={40}
                  />
                ...
                <span className="font-poppins font-semibold text-left text-black group-hover:text-fuchsia-950 text-sm">
                  Get Capital Gains in fetch real-time data for stocks and
                  mutual funds
                </span>
              </div>
            </div>
            ...
            <div className="w-full md:w-1/2  md:ml-20 m-4 md:m-5 align-middle">
              <Image
                src={require("../../app/assets/logo/DemoImg.png")} // Path to your image file
              ...
              <p className="font-poppins text-left text-gray-700 text-sm mt-1 font-normal">
                ...
                allows you to manage multiple asset classes with ease and
                provides insights on your portfolio performance.
              </p>
            </div>
          </div>
          <div className="w-full bg-[#5E2751] h-auto mb-5 p-2">
            <div className="flex flex-col justify-center items-center ml-5 mr-5 mt-5">
              ...
              <div className="flex flex-wrap justify-center gap-10 p-6">
                {/* Card 1 */}
                <Card
                  src={require("../../app/assets/logo/Trader.png")}
                ...
                {/* Card 2 */}
                <Card
                  src={require("../../app/assets/logo/Trader1.png")}
                  alt="Investors"
                  header="Investors"
                ...
                {/* Card 3 */}
                <Card
                  src={require("../../app/assets/logo/Trader2.png")}
                  alt="Family Offices"
                ...
                {/* Card 4 */}
                <Card
                  src={require("../../app/assets/logo/Trader3.png")}
                  alt="Fund Meter"
                  header="Fund Meter"
                  description="Ready-made Stocks & Mutual Funds Portfolios"
                />
